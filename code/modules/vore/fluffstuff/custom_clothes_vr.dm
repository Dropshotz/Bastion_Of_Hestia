...
/obj/item/clothing/suit/storage/fluff/cedrick_coat
	name = "Sol Humanist Overcoat"
	desc = "An authoritarian looking coat, bearing the markings of a well known Human speciest organization."
	icon = 'icons/vore/custom_clothes_vr.dmi'
	icon_state = "cedrickcoat"
	icon_override = 'icons/vore/custom_clothes_vr.dmi'
	item_state = "cedrickcoat_mob"
//	armor = list(melee = 10, bullet = 5, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0)

/obj/item/clothing/head/fedora/fluff/cedrickhat
	name = "Sol Humanist Hat"
	desc = "Holds the markings of a well known Sol Humanist group. The wearer is probably a bigot."
	icon = 'icons/vore/custom_clothes_vr.dmi'
	icon_state = "cedrickhat"
	icon_override = 'icons/vore/custom_clothes_vr.dmi'
