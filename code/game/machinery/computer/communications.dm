...
//	var/datum/lore/atc_controller/ATC
	var/datum/lore/anno_controller/ANN
...
/*		if("toggleatc")
		...
		if("toggleann")
			src.ANN.squelched = !src.ANN.squelched
		if("viewmessage")
...
//			dat += "<BR>\[ <A HREF='?src=\ref[src];operation=toggleatc'>[ATC.squelched ? "Enable" : "Disable"] ATC Relay</A> \]"
			dat += "<BR>\[ <A HREF='?src=\ref[src];operation=toggleatc'>[ANN.squelched ? "Enable" : "Disable"] ANN Relay</A> \]"
...
//			dat += "<BR>\[ <A HREF='?src=\ref[src];operation=toggleatc'>[ATC.squelched ? "Enable" : "Disable"] ATC Relay</A> \]"
			dat += "<BR>\[ <A HREF='?src=\ref[src];operation=toggleann'>[ANN.squelched ? "Enable" : "Disable"] ANN Relay</A> \]"
		if(STATE_CALLSHUTTLE)
